...
logging.basicConfig(
    ...
    filename=r'E:\VscodePractice\knowlodge_graph\traditional_ner_disambig.log',
    filemode='w',
    encoding='utf-8'
)
...
with open("E:\VscodePractice\knowlodge_graph\\turing_raw_data_zhcn.txt", "r", encoding="utf-8") as f:
    raw_text = f.read()


def task1_traditional_ner(text, output_file="E:\VscodePractice\knowlodge_graph\\task1_traditional_ner.json"):
...
def task2_traditional_disambiguation(input_file, output_file="task2_traditional_disambig.json"):
...
def task2_vector_disambiguation(text, input_file, output_file="E:\VscodePractice\knowlodge_graph\\task2_clusters.json"):
...
def save_to_json(data, filename="E:\VscodePractice\knowlodge_graph\\task2_final_linked_entities.json"):
...
if __name__ == "__main__":
    ...
    # task2_vector_disambiguation(raw_text, ner_file)
    final_data = disambiguate_and_link(json.load(open(ner_file, "r", encoding="utf-8")), raw_text)
